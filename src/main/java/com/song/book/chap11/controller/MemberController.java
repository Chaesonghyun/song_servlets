package com.song.book.chap11.controller;
...
import com.song.book.chap11.dao.DaoException;
import com.song.book.chap11.dao.Member;
import com.song.book.chap11.dao.MemberDao;
import com.song.book.chap11.dao.MemberDaoImpl;
import com.song.web.common.Controller;
import com.song.web.common.RequestMapping;
import com.song.web.common.RequestMapping.RequestMethod;
...
public class MemberController {
	...
	public void members(HttpServletRequest request,
		...
		forward("/WEB-INF/jsp/member.jsp", request, response);
	}
